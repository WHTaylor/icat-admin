...
const Tips = () => (
    <div class="page">
        ...
        <ul>
            ...
            <li>Start typing an entity name and press enter to open a new tab for that entity type. Only works if the
                main page body has focus, press escape to clear anything that has been typed so far. Autocompletes to
                the entity name with the longest matching subsequence.
            </li>
